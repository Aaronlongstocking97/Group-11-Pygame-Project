...
class Hallway(Scene):
    ...
    def init_hallway(self, callback):
        ...
        callback.pencil.init_pencil(
            self, (300, 300), "This is a pencil. You may use it to answer some questions")
        ...
        callback.door_to_exit.init_exit(
            self, (500, 500), "It's locked! You can't leave the school.")
